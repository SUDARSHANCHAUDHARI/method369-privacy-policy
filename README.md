# Method369 Privacy Policy

This repository contains the public privacy policy for Method369.

- Privacy policy: [PRIVACY_POLICY.md](PRIVACY_POLICY.md)
- Web version: https://sudarshanchaudhari.github.io/method369-privacy-policy/
...
Method369 ("we," "our," or "us") is an Android app. Method369 is a 369 manifestation ritual app for Android that stores ritual progress and preferences locally on your device. This Privacy Policy explains what information the app collects, how it is used, and the choices you have. By installing or using Method369 you agree to the practices described below.

## Information We Collect

### Location Data
- Method369 does not collect location data.

### Account Information
- No account is required to use Method369.

### Device Information
- Ritual entries, streaks, reminder settings, and app preferences are stored locally.

## How We Use Your Information

### Location Sharing
- Method369 does not use your location.

### Account Management
- Track manifestation ritual progress and reminders locally.

### Service Improvement
- Improve local ritual workflows and reminder reliability.
- We do not sell, rent, or monetize your ritual data.

## Storage and Retention

### Data Storage
- Ritual data and preferences are stored locally on your device.
- No Sudarshan Tech Labs cloud server is used for ritual data.

### Data Retention
- Local ritual data remains until you delete it, clear app data, or uninstall the app.
...
### Family Groups
- Method369 does not use MyFamilyTracker-style family groups unless explicitly described in this policy.
...
### Third Parties
- No ritual data is shared with third parties by Sudarshan Tech Labs.
...
* **POST_NOTIFICATIONS**: Used for ritual reminders.
* **RECEIVE_BOOT_COMPLETED**: Used to restore reminders after device restart.

### Optional Permissions

* Notifications are optional and can be disabled in Android settings.

## Your Rights and Controls

### Location Sharing Control
- No location sharing exists in Method369.

### Account Management
- No account is required.

### Data Access
- You can view, edit, or delete local ritual data in the app.
...
### Permissions
- You can revoke Android permissions in Android Settings -> Apps -> Method369 -> Permissions.
...
* **GitHub Repository:** https://github.com/SUDARSHANCHAUDHARI/method369-privacy-policy
* **Email:** sunny.sudarshan@gmail.com
* **Main App Repository:** https://github.com/SUDARSHANCHAUDHARI/Method369
...
- Subject: "Data Deletion Request - Method369"
...
- No third-party cloud service is required for core ritual tracking.
...
Method369 is built with privacy in mind. The app is built with:
- Kotlin and Jetpack Compose
- Local ritual tracking
- Android notifications and boot reminder restore
...
- **Clarified local ritual data and notification permissions.**
